 ...
 */
CREATE OR REPLACE FUNCTION get_actor_ids(text_param text) RETURNS TABLE(actor_id INTEGER) AS

$$
SELECT actor_id FROM actor WHERE first_name ILIKE text_param || '%' ORDER BY actor_id
$$
